...
export class FindOptionsUtils {
    ...
    static mergeFindOptionsRelationsWithEagerRelations(findOptionsRelations, relations) {
        return relations.reduce((acc, relation) => {
            if (relation.inverseEntityMetadata.eagerRelations.length) {
                if (findOptionsRelations.hasOwnProperty(relation.propertyPath) &&
                    typeof findOptionsRelations[relation.propertyPath] === "object") {
                    return {
                        ...acc,
                        [relation.propertyPath]: this.mergeFindOptionsRelationsWithEagerRelations((findOptionsRelations[relation.propertyPath]), relation.inverseEntityMetadata.eagerRelations),
                    };
                }
                else {
                    return {
                        ...acc,
                        [relation.propertyPath]: this.mergeFindOptionsRelationsWithEagerRelations({}, relation.inverseEntityMetadata.eagerRelations),
                    };
                }
            }
            else {
                if (findOptionsRelations.hasOwnProperty(relation.propertyPath)) {
                    return {
                        ...acc,
                        [relation.propertyPath]: findOptionsRelations[relation.propertyPath],
                    };
                }
                else {
                    return {
