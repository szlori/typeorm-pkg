...
export declare class FindOptionsUtils {
    ...
    static mergeFindOptionsRelationsWithEagerRelations<Entity>(findOptionsRelations: FindOptionsRelations<Entity>, relations: RelationMetadata[]): FindOptionsRelations<Entity>;
